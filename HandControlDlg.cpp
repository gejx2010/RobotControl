...
void CHandControlDlg::OnButtonSeth() 
{
	...
	doc=view->GetDocument()->doc_delay; 
	former_ang[0]=doc->jnt0;
	former_ang[1]=doc->jnt1*PI/180;
	former_ang[2]=doc->jnt2*PI/180;
	former_ang[3]=doc->jnt3*PI/180;
	former_ang[4]=doc->jnt4*PI/180;
	former_ang[5]=doc->jnt5*PI/180;
	former_ang[6]=doc->jnt6*PI/180;
	former_ang[7]=doc->jnt7*PI/180;
